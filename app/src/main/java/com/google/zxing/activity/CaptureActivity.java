...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private LinearLayout linear_scan_center;
    ...
    public void onCreate(Bundle icicle) {
        ...
        img_waiting = (ImageView) findViewById(R.id.img_waiting);
        linear_scan_center = (LinearLayout) findViewById(R.id.linear_scan_center);
        mIntent = getIntent();
